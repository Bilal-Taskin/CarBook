...
namespace CarBook.Persistance.Repositories.CommentRepositories
{
    public class CommentRepository<T> : IGenericRepository<Comment>
    {
        ...
        public List<Comment> GetCommnetsByBlockId(int id)
        {
            return _context.Set<Comment>().Where(x=>x.BlockId ==id).ToList();  
        }
        ...
        {
            return _context.Comments.Where(x => x.BlockId == id).Count();
        }
    }
}
