...
{
    public class RemoveTagCloudCommandHandler : IRequestHandler<RemoveTagCoudCommand>
    {
        ...
        public async Task Handle(RemoveTagCoudCommand request, CancellationToken cancellationToken)
        {
